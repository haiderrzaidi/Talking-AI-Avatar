...
// Assuming this code is inside a function or an event listener
if (document.querySelector('input[name="options"]:checked').value === window[lang][countQues].choices[window[lang][countQues].answer - 1]) {
    ...
    document.getElementById("ques-container").innerHTML += "<div class='ques-circle correct'>" + (countQues + 1) + "</div>";
} else {
    score -= 5;
    document.getElementById("score").textContent = "Score : " + score;
    document.getElementById("ques-container").innerHTML += "<div class='ques-circle incorrect'>" + (countQues + 1) + "</div>";
}

// Show the container after circles are added
document.getElementById("ques-container").classList.add("show");
